(function($) {
    ...
    $(function() {
      ...
      if ($("#airforce-visit-sale-chart").length) {
        Chart.defaults.global.legend.labels.usePointStyle = true;
        var ctx = document.getElementById('airforce-visit-sale-chart').getContext("2d");
              ...
              datasets: [
                {
                  ...
                  borderWidth: 1,
                  fill: 'origin',
                  data: [20, 40, 15, 35, 25, 50, 30, 20 , 50 , 40, 70, 30]
                },
                {
                  label: "USA",
                  ...
                  borderWidth: 1,
                  fill: 'origin',
                  data: [40, 30, 20, 10, 50, 15, 35, 40, 60, 20, 60, 70]
                },
                {
                  label: "UK",
                  borderColor: gradientStrokeBlue,
                  ...
                  borderWidth: 1,
                  fill: 'origin',
                  data: [70, 10, 30, 40, 25, 50, 15, 30 , 40, 50, 30 ,60]
                }
            ]
          },
          options: {
        ...
        $("#airforce-visit-sale-chart-legend").html(myChart.generateLegend());
      }
      if ($("#airforce-visit-sale-chart-dark").length) {
        Chart.defaults.global.legend.labels.usePointStyle = true;
        var ctx = document.getElementById('airforce-visit-sale-chart-dark').getContext("2d");
      ...
      if ($("#airforce-chart").length) {
        ...
        var trafficChartCanvas = $("#airforce-chart").get(0).getContext("2d");
        var trafficChart = new Chart(trafficChartCanvas, {
          type: 'doughnut',
          data: trafficChartData,
          options: trafficChartOptions
        });
        $("#airforce-chart-legend").html(trafficChart.generateLegend());      
      }
